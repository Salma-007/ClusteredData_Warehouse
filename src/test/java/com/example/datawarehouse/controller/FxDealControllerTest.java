...
//
//    @Test
//    void importDeals_WhenInvalidRequestData_ShouldReturnBadRequest() throws Exception {
//        // Arrange: Créer une requête invalide (par exemple, fromCurrencyIsoCode vide)
//        FxDealRequest invalidRequest = FxDealRequest.builder()
//                .dealUniqueId("FX001")
//                .fromCurrencyIsoCode("") // Invalide
//                .toCurrencyIsoCode("EUR")
//                .dealTimestamp(LocalDateTime.now())
//                .dealAmount(new BigDecimal("1000.00"))
//                .build();
//        List<FxDealRequest> requests = Collections.singletonList(invalidRequest);
//
//        // Act & Assert: MockMvc simule la validation de Spring (@Valid)
//        mockMvc.perform(post("/deals/import")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(objectMapper.writeValueAsString(requests)))
//                .andExpect(status().isBadRequest()); // Devrait retourner 400 en raison de la validation
//    }
//
//    // --- Test: GET /deals ---
//
